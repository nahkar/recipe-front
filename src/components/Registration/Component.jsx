...
export default function Registration({ history }) {
  ...
  const registration = (registerData, history) =>
    dispatch(userRegistration({ registerData, history }));
        ...
        <RegistrationStyled.Form onSubmit={handleSubmit(onSubmit)}>
          ...
          {errors.email && (
            <RegistrationStyled.Error>
              Email must have at least {MIN_LENGTH} characters
            </RegistrationStyled.Error>
          )}
          ...
          <Link to={routes.login} style={{ textDecoration: 'none' }}>
            <RegistrationStyled.LinkReg>
              If you have registered before, you can LOGIN
            </RegistrationStyled.LinkReg>
          </Link>
