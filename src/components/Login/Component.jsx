    ...
    <LoginStyled.MainBg>
      <LoginStyled.Form onSubmit={handleSubmit(onSubmit)}>
        ...
        <Input
          ...
          propsRef={register({ required: true, minLength: MIN_LENGTH })}
        />

        {errors.email && errors.email.type === 'required' && (
          <LoginStyled.Error>This field is required</LoginStyled.Error>
        )}
        {errors.email && errors.email.type === 'minLength' && (
          <LoginStyled.Error>
            This field is required minLength of {MIN_LENGTH} symbols
          </LoginStyled.Error>
        )}
